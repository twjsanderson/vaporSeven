...
import {
  domains,
  discordPhishing 
} from './src/resources/domains';
import { JSONDomains, additionalDomains } from './src/resources/JSONDomains';
import {
  emails,
  disposableEmails
} from './src/resources/emails'; 

import { errorHandler } from './src/utils/httpResponses/handlers';
...
app.get('/url', (req: Request, res: Response) => {
  ...
  const simplifiedUrl: any = formattedUrl.length > 1 ? searchJSONDomainsStream(formattedUrl[1], JSONDomains) : false;
